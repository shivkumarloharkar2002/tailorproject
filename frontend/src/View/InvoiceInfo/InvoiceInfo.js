            ...
            <div className="invoiceInfo">
                ...
                <div className="invoiceInfo-box">
                    ...
                    <p className="invoiceInfo-box-p">
                        Shrigonda, Shrigonda <br /> Ahmednagar, Maharastra,414402 <br />{" "}
                        Ph:5133145125
                    </p>
                                ...
                                <>
                                    <div className="invoiceInfo-box-info">
                                        <div className="invoiceInfo-box-name-para">
                                            ...
                                            <p className="invoiceInfo-box-name">{data.date}</p>
                                        </div>
                                        <p className="invoiceInfo-box-name-2">Bill To: {data.name}</p>
                                        ...
                                        <div className="invoiceInfo-box-color-para-info">
                                            <p className="invoiceInfo-box-color-para-p">{data.item}</p>
                                            <p className="invoiceInfo-box-color-para-p">{data.quantity}</p>
                                            <p className="invoiceInfo-box-color-para-p">{data.date}</p>
                                            <p className="invoiceInfo-box-color-para-p">{data.price}/-</p>
                                        </div>
